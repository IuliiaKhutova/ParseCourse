...
import json
import scrapy
from ..items import InstaTag, InstaPost, InstaFollow, InstaFollowers,InstaUser
...
class InstagramSpider(scrapy.Spider):
    ...
    def get_api_followers_request(self, response, user_data, variables=None):
        ...
        yield response.follow(url_follower, callback=self.get_api_follow, cb_kwargs={'user_data': user_data})
